...
<head>
    ...
    <title>Merci pour votre reservation</title>
...
<?php 
                ...
                $sql = "INSERT INTO guest (guest_id, firstname, lastname, adresse, contactno, dateReserv) VALUES (NULL, "; 
                if (isset($_GET['firstname'])) {
                    $sql = $sql . "'" . $_GET['firstname'] . "',";
                }
                if (isset($_GET['lastname'])) {
                    $sql = $sql . "'" . $_GET['lastname'] . "',";
                }
                if (isset($_GET['adresse'])) {
                    $sql = $sql . "'" . $_GET['adresse'] . "',";
                }
                if (isset($_GET['contactno'])) {
                    $sql = $sql . "'" . $_GET['contactno'] . "',";
                }
                if (isset($_GET['date'])) {
                    $sql = $sql . "'" . $_GET['date'] . "')";
                }
     ...
     if (isset($_GET['Connexion'])){
        ...
        <section>
                ...
                <div class = "well col-md-4">
                    <center><h3>Merci pour votre réservation</h3></center>
                    <br />
                    <center><h4>Merci!</h4></center>
                    <br />
                    <center><a href = "index.php?Connexion=Oui" class = "btn btn-success">Retour au menu</a></center>
        </section>
