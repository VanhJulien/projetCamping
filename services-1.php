                    ...
                    <div class="row">
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_randonnee.png" alt="image de randonnée"></a>
                                <div class="content-area">
                                    <h3 class="title">Randonnée</h3>
                                    <div class="content">Comment aller en camping sans faire de la randonnée? 
                                        Nous proposons de multiples chemins de randonnée afin de découvrir des paysages extraordinaires.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_parapente.png" alt="image de parapente"></a>
                                <div class="content-area">
                                    <h3 class="title">Parapente</h3>
                                    <div class="content">Il y a beaucoup de zones de parapente dans les environs, c'est une activité 
                                    à sensation forte faisable avec son enfant.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_restaurant.png" alt="image de restaurants"></a>
                                <div class="content-area">
                                    <h3 class="title">Restauration</h3>
                                    <div class="content">Avec des plats typiques de la montagne comme des raclettes, fondues ou tartifletes
                                    nous vous proposons des menus très variés et équilibrés.</div>
                                </div>
                            </div>
                        </div>
                    </div>
