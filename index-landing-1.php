     ...
     if (isset($_GET['Connexion'])){
        ...
        <header id="headerwrap" class="backstretched no-overlay fullheight">
            <div class="container vertical-center">
                <div class="intro-text vertical-center text-left smoothie">
                    ...
                    <div class="intro-sub-heading wow fadeIn secondary-font" data-wow-delay="0.4s">Profitez de nos <span class="rotate">piscines, lacs, activités</span></div>
                    <a href="index-corporate-1.html" class="btn btn-primary btn-white mt30 page-scroll" data-wow-delay="0.6s">Apprenez-en plus ici</a>
                </div>
            </div>
        </header>
            ...
            <div class="col-sm-6 nopadding-lr match-height white-bg" data-mh="promo-inner">
                <div class="section-inner pad-sides-60 promo-inner">
                    <div class="col-sm-8 col-sm-offset-2">
                        <h3 class="mt0">Forfait Standard</h3>
                        <p class="lead"> -1 tente <br> -1 voiture <br> -2 personnes <br> -Sans électricité <br><br> <b>35.00€</b></p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 nopadding-lr match-height" data-mh="promo-inner">
                <div class="section-inner pad-sides-60 promo-inner">
                    <div class="col-sm-8 col-sm-offset-2">
                        <h3 class="mt0">Forfait Confort </h3>
                        <p class="lead"> -1 caravane ou tente ou camping-car <br> -1 voiture <br> -4 personnes <br> -Avec électricité <br><br><b>49.00€</b></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 nopadding-lr match-height white-bg" data-mh="promo-inner">
                <div class="section-inner pad-sides-60 promo-inner">
                    <div class="col-sm-8 col-sm-offset-2">
                        <h3 class="mt0">Extra</h3>
                        <p class="lead">-Adultes et enfants de + 7 ANS supp. <br> <b>10.00€ </b> <br><br>-Chien <br> <b>4.00€</b> <br><br>-Location de Frigo <br><br> <b>5.00€</b> </p>
                    </div>
                </div>
            </div>

            <div class="col-sm-6 nopadding-lr dark-wrapper remove-opacqued-bg opaqued background-cover match-height" style="background-image: url('assets/img/bg/bg8.jpg');" data-mh="promo-inner">
                <div class="dark-opaqued section-inner pad-sides-60 text-right promo-inner"></div>
            </div>
        </div>
