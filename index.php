        ...
        <header id="headerwrap" class="dark-wrapper backstretched special-max-height no-overlay">
            <div class="container vertical-center">
                <div class="intro-text vertical-center text-left smoothie">
                    ...
                    <div class="intro-sub-heading wow fadeIn secondary-font" data-wow-delay="0.4s">Consultez notre site afin de découvrir <span class="rotate">nos photos, nos forfaits, notre équipe</span></div>
                </div>
            </div>
        </header>
<?php
                        ...
                        <ul class="masonry-portfolio-items isotope list-unstyled">
                                ...
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-corporate-1.php?Connexion=Oui" title="view project">Présentation du camping</a></h3>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="contact-us-1.php?Connexion=Oui" title="view project">Notre équipe</a></h3>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-shop.php?Connexion=Oui" title="view project">Se connecter / Créer un compte</a></h3>
                        ...
                        <ul class="masonry-portfolio-items isotope list-unstyled">
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-corporate-1.php" title="view project">Présentation du camping</a></h3>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="contact-us-1.php" title="view project">Notre équipe</a></h3>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-shop.php" title="view project">Se connecter / Créer un compte</a></h3>
