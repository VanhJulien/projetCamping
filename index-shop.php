...
<head>
    ...
    <title>Inscription / Se connecter</title>
                ...
                <div class="container">
                    <div class="row mb50">
                        ...
                        if (isset($_GET['Connexion'])){
                            ...
                            ?> 
                            <a href="login.php">Cliquez ici</a><span> pour vous déconnecter ou changer de compte.</span>
                        <?php
                    } else { 
                        echo 'Vous êtes actuellement déconnecté.'?>
                        <a href="login.php">Cliquez ici</a><span> pour vous connecter sur votre compte ou en créer un nouveau.</span>
                    <?php } ?>
                    </div>
                </div>
            </div>
