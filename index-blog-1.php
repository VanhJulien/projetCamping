                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 mt30 wow text-center">
                            <h2 class="section-heading">Paysages</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_paysage_1.png" alt="image_paysage_1"></a>
                                <div class="content-area">
                                    <h3 class="title">Logements</h3>
                                    <div class="content">Super vue depuis les logements proposés.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="2s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_paysage_2.png" alt="image_paysage_2"></a>
                                <div class="content-area">
                                    <h3 class="title">Ou depuis un point de randonnée</h3>
                                    <div class="content">On aura des occasions lors de ballades de se reposer avec une vue comme celle là.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="4s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_paysage_3.png" alt="image_paysage_3"></a>
                                <div class="content-area">
                                    <h3 class="title">Ou depuis un autre point de randonnée</h3>
                                    <div class="content">Celle là, a été prise récemment et n'est pas moins impressionante.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="6s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_paysage_4.png" alt="image_paysage_4"></a>
                                <div class="content-area">
                                    <h3 class="title">Hiver</h3>
                                    <div class="content">En hiver la neige apaise nos yeux avec sa beautée surprenante.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="8s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_paysage_5.png" alt="image_paysage_5"></a>
                                <div class="content-area">
                                    <h3 class="title">Aube</h3>
                                    <div class="content">Levez vous avec une splendide vue au loin.</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="10s">
                            <div class="icon-box-1 match-height mb30">
                                <img src= "assets/img/image_paysage_6.png" alt="image_paysage_6"></a>
                                <div class="content-area">
                                    <h3 class="title">Crépuscule</h3>
                                    <div class="content">Finissez votre belle journée sur le plus beau couché de soleil de votre vie.</div>
                                </div>
                            </div>
                        </div>
                    </div>
