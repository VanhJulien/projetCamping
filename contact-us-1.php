                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    <li><a href="index-blog-1.php?Connexion=Oui">Notre équipe</a></li>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    <li><a href="index-blog-1.php">Notre équipe</a></li>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <div class="content-area">
                                    <h3 class="title">Thibault Balleux</h3>
                                    <div class="content"> PHP Inscription/Connexion (base de donnée camping)</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <div class="content-area">
                                    <h3 class="title">Pierrick Bauffe</h3>
                                    <div class="content">Pages HTML activités, album photo, présentation du camping</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <div class="content-area">
                                    <h3 class="title">Julien Vanhauwaert</h3>
                                    <div class="content">Page HTML index, Notre équipe, Inscription/Se connecter, en-tête, bas de page, PHP Inscription/Connexion, condition PHP connecté ou non, logo du site</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <div class="content-area">
                                    <h3 class="title">Théo Viseur</h3>
                                    <div class="content">PHP Réservation + base de données test_campingouin</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="icon-box-1 match-height mb30">
                                <div class="content-area">
                                    <h3 class="title">Benjamin Watson</h3>
                                    <div class="content">Page HTML Forfaits, images, aide</div>
                                </div>
                            </div>
                        </div>
                    </div>
